...
class OpenRouterProvider(BaseProvider):
    def __init__(self, model_config: dict):
        ...
        base_url = model_config.get("extra_kwargs", {}).get("base_url", "https://openrouter.ai/api/v1")
        try:
            import openai
            self._client = openai.OpenAI(
                ...
                base_url=base_url,
                default_headers={
                    "HTTP-Referer": "plant-maintenance-tool",
                    "X-Title": "Plant Maintenance AI Comparison",
                },
            )
        except ImportError:
    ...
    def stream_query(
        ...
        try:
            ...
            error_callback(f"OpenRouter API error: {exc}")
